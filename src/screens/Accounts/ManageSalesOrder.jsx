                        ...
                        <View style={{ marginTop: hp(1) }}>
                            ...
                            <View style={styles.billContainer}>
                                ...
                                <View style={styles.rowInput}>
                                        ...
                                        <View style={styles.helpIconWrapper}>
                                            ...
                                            {showShippingTip && (
                                                <>
                                                    ...
                                                    >
                                                        <TouchableWithoutFeedback onPress={() => setShowShippingTip(false)}>
                                    ...
                                    <Text style={styles.value}>₹{parseFloat(shippingCharges || 0).toFixed(2)}</Text>
                                </View>
                                ...
                                <View style={styles.rowInput}>
                                        ...
                                        <View style={styles.helpIconWrapper}>
                                            ...
                                            {showAdjustmentTip && (
                                                <>
                                                    ...
                                                    >
                                                        <TouchableWithoutFeedback onPress={() => setShowAdjustmentTip(false)}>
                                                            <View style={styles.modalOverlay} />
                                                        </TouchableWithoutFeedback>
                                                    </Modal>
                                                    <View style={styles.tooltipBox}>
                                                        <Text style={styles.tooltipText}>
                                                            Additional charges or discounts applied to the order.
                                                        </Text>
                                                        <View style={styles.tooltipArrow} />
                                                    </View>
                                                </>
                                    ...
                                    <Text style={styles.value}>₹{parseFloat(adjustments || 0).toFixed(2)}</Text>
                                </View>
